...
export function PlasticList({ email, onEmailSubmit }: PlasticListProps) {
  ...
  useEffect(() => {
    const originalRows: RowData[] = [
      ...
      { "name": "Burger", "brand": "In-N-Out", "category": "Fast Food", "packaging_type": "Paper" },
      { "name": "Water Filter", "brand": "Berkey", "category": "Home Appliances", "packaging_type": "Metal" },
      { "name": "Cheese Sticks", "brand": "Organic Valley", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Mascara", "brand": "", "category": "Cosmetics", "packaging_type": "Plastic" },
      { "name": "Classic Yellow Mustard", "brand": "French's", "category": "Condiments", "packaging_type": "Plastic" },
      ...
      { "name": "Plain Kefir Beverage", "brand": "Trader Joe's", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Rotisserie Chicken", "brand": "Costco", "category": "Meat", "packaging_type": "Plastic" },
      { "name": "Sour Patch Kids", "brand": "", "category": "Candy", "packaging_type": "Plastic" },
      { "name": "Sour Spaghettini", "brand": "Haribo", "category": "Candy", "packaging_type": "Plastic" },
      { "name": "Naproxen", "brand": "Aleve", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Calcium Carbonate", "brand": "Tums", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Famotidine", "brand": "Pepcid AC", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Omeprazole", "brand": "Prilosec", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Cetirizine", "brand": "Zyrtec", "category": "Medication", "packaging_type": "Plastic" },
      ...
      { "name": "Yogurt", "brand": "Straus", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Energy Drink", "brand": "Celsius", "category": "Beverages", "packaging_type": "Metal" },
      { "name": "Twist n Loc Container", "brand": "Ziploc", "category": "Food Storage", "packaging_type": "Plastic" },
      { "name": "Mushrooms", "brand": "", "category": "Produce", "packaging_type": "Plastic" },
      { "name": "Sugar-Free Fiber Supplement", "brand": "Meta Mucil", "category": "Supplements", "packaging_type": "Plastic" },
      ...
      { "name": "Coffee Machine", "brand": "Nespresso", "category": "Home Appliances", "packaging_type": "Plastic" },
      { "name": "Chicken Bowl", "brand": "Chipotle", "category": "Fast Food", "packaging_type": "Plastic" },
      { "name": "Coffee", "brand": "Philz", "category": "Beverages", "packaging_type": "Paper" },
      { "name": "Alkaline Water", "brand": "Carlsbad", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Diet Coke", "brand": "Coca-Cola", "category": "Beverages", "packaging_type": "Metal" },
      { "name": "Spring Water", "brand": "Mountain Valley", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Storage Bag", "brand": "Ziploc", "category": "Food Storage", "packaging_type": "Plastic" },
      { "name": "American Cheese Slices", "brand": "Kraft Singles", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Coarse Ground Black Pepper", "brand": "Kirkland", "category": "Spices", "packaging_type": "Plastic" },
      { "name": "Wild Caught Alaska Halibut", "brand": "Kirkland", "category": "Frozen Seafood", "packaging_type": "Plastic" },
      { "name": "Sliced Sharp Natural Cheddar Cheese", "brand": "Sargento", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Wild Caught Mahi-Mahi", "brand": "Kirkland", "category": "Frozen Seafood", "packaging_type": "Plastic" },
      { "name": "Splenda", "brand": "", "category": "Sweeteners", "packaging_type": "Paper" },
      { "name": "Mixed Nuts", "brand": "", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "Coffee K-Cups", "brand": "Starbucks", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Whey Protein Isolate Powder", "brand": "Bulk Supplements", "category": "Sports Nutrition", "packaging_type": "Plastic" },
      { "name": "Water", "brand": "Acqua Panna", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Yakult", "brand": "", "category": "Probiotics", "packaging_type": "Plastic" },
      { "name": "Butter", "brand": "Kerrygold", "category": "Dairy", "packaging_type": "Paper" },
      { "name": "Water Filter", "brand": "ZeroWater", "category": "Home Appliances", "packaging_type": "Plastic" },
      { "name": "Tea Bags", "brand": "Organic India", "category": "Beverages", "packaging_type": "Paper" },
      { "name": "Protein Bar", "brand": "Kirkland", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "Lemonade", "brand": "Aussie", "category": "Beverages", "packaging_type": "Metal" },
      { "name": "Cherry Blast Energy Drink", "brand": "Lucozade Alert", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Water Bottles", "brand": "Kirkland", "category": "Beverages", "packaging_type": "Plastic" },
      ...
      { "name": "Analgesics", "brand": "", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Analgesic Tablets", "brand": "", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Whey Protein Powder", "brand": "Naked Nutrition", "category": "Sports Nutrition", "packaging_type": "Plastic" },
      { "name": "Mineral Water", "brand": "Topo Chico", "category": "Beverages", "packaging_type": "Glass" },
      { "name": "Organic Multivitamin", "brand": "Kirkland Signature", "category": "Supplements", "packaging_type": "Plastic" },
      { "name": "Cheddar Pop Mmms Baked Snack Crackers", "brand": "Simple Mills", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "Soup Dumplings", "brand": "Mila", "category": "Frozen Foods", "packaging_type": "Plastic" },
      { "name": "Garlic Herb Elite Tuna", "brand": "Safe Catch", "category": "Canned Seafood", "packaging_type": "Metal" },
      { "name": "Organic Tuscan Marinara", "brand": "Kirkland Signature", "category": "Pasta Sauce", "packaging_type": "Glass" },
      { "name": "Toothpaste", "brand": "3M CLINPRO", "category": "Oral Care", "packaging_type": "Plastic" },
      { "name": "Yogurt", "brand": "Siggi's", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Spring Water", "brand": "", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Iced Tea", "brand": "365 by Whole Foods Market", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Whey Protein Powder", "brand": "Ascent", "category": "Sports Nutrition", "packaging_type": "Plastic" },
      { "name": "Fig Bars", "brand": "Nature's Bakery", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "AG1", "brand": "Athletic Greens", "category": "Supplements", "packaging_type": "Plastic" },
      { "name": "Potato Chips", "brand": "Kettle Brand", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "Psyllium Husk", "brand": "", "category": "Supplements", "packaging_type": "Plastic" },
      { "name": "Quick Cooking Steel Cut Oats", "brand": "Bob's Red Mill", "category": "Breakfast Cereal", "packaging_type": "Plastic" },
      ...
      { "name": "Women's Probiotics", "brand": "1MD", "category": "Supplements", "packaging_type": "Plastic" },
      ...
      { "name": "Tea Bag", "brand": "Lipton", "category": "Beverages", "packaging_type": "Paper" },
      { "name": "Water", "brand": "Fiji", "category": "Beverages", "packaging_type": "Plastic" },
      ...
      { "name": "Olive Oil", "brand": "Graza", "category": "Cooking Ingredients", "packaging_type": "Metal" },
      { "name": "Flour", "brand": "King Arthur", "category": "Baking Ingredients", "packaging_type": "Paper" },
      { "name": "Free Range Chicken", "brand": "Mary's", "category": "Meat", "packaging_type": "Plastic" },
      { "name": "Whole Milk Yogurt", "brand": "Nancy's", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Jerky", "brand": "Bored", "category": "Snacks", "packaging_type": "Plastic" },
      ...
      { "name": "Baby Formula", "brand": "Enfamil", "category": "Baby Food", "packaging_type": "Metal" },
      { "name": "Shibuya", "brand": "", "category": "Unknown", "packaging_type": "Unknown" },
      { "name": "Big Mac", "brand": "McDonald's", "category": "Fast Food", "packaging_type": "Paper" },
      { "name": "Koia", "brand": "", "category": "Unknown", "packaging_type": "Unknown" },
      { "name": "Bananas", "brand": "Dole", "category": "Produce", "packaging_type": "Plastic" },
      { "name": "Greek Yogurt", "brand": "Greek Gods", "category": "Dairy", "packaging_type": "Plastic" },
      ...
      { "name": "Protein Shake", "brand": "Fairlife", "category": "Sports Nutrition", "packaging_type": "Plastic" },
      { "name": "Coffee Cup", "brand": "Starbucks", "category": "Beverages", "packaging_type": "Paper" },
