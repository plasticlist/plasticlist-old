...
export function Votes({ email, onEmailSubmit }: PlasticListProps) {
  ...
  useEffect(() => {
    const originalRows: RowData[] = [
      ...
      { "name": "Koia Water", "category": "Water", "packaging_type": "Plastic Bottle" },
      ...
      { "name": "In-N-Out Burger", "brand": "In-N-Out", "category": "Fast Food", "packaging_type": "Paper" },
      { "name": "Berkey Water Filter", "brand": "Berkey", "category": "Home Appliances", "packaging_type": "Metal" },
      { "name": "Organic Valley Cheese Sticks", "brand": "Organic Valley", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Mascara", "brand": "", "category": "Cosmetics", "packaging_type": "Plastic" },
      { "name": "French's Classic Yellow Mustard", "brand": "French's", "category": "Condiments", "packaging_type": "Plastic" },
      { "name": "Mozzarella", "brand": "", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Spatula", "brand": "", "category": "Kitchen Utensils", "packaging_type": "Plastic" },
      { "name": "Trader Joe's Plain Kefir Beverage", "brand": "Trader Joe's", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Costco Rotisserie Chicken", "brand": "Costco", "category": "Meat", "packaging_type": "Plastic" },
      { "name": "Sour Patch Kids", "brand": "", "category": "Candy", "packaging_type": "Plastic" },
      { "name": "Haribo Sour Spaghettini", "brand": "Haribo", "category": "Candy", "packaging_type": "Plastic" },
      { "name": "Aleve Naproxen", "brand": "Aleve", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Tums Calcium Carbonate", "brand": "Tums", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Pepcid AC Famotidine", "brand": "Pepcid AC", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Prilosec Omeprazole", "brand": "Prilosec", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Zyrtec Cetirizine", "brand": "Zyrtec", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Cooking Oil", "brand": "", "category": "Cooking Ingredients", "packaging_type": "Plastic" },
      { "name": "Chocolate Bar", "brand": "", "category": "Candy", "packaging_type": "Plastic" },
      { "name": "Monk Fruit Sweetener", "brand": "", "category": "Sweeteners", "packaging_type": "Plastic" },
      { "name": "Protein Powder", "brand": "", "category": "Sports Nutrition", "packaging_type": "Plastic" },
      { "name": "Garden Hose Water", "brand": "", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Straus Yogurt", "brand": "Straus", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Celsius Energy Drink", "brand": "Celsius", "category": "Beverages", "packaging_type": "Metal" },
      { "name": "Ziploc Twist n Loc Container", "brand": "Ziploc", "category": "Food Storage", "packaging_type": "Plastic" },
      { "name": "Mushrooms", "brand": "", "category": "Produce", "packaging_type": "Plastic" },
      { "name": "Meta Mucil Sugar-Free Fiber Supplement", "brand": "Meta Mucil", "category": "Supplements", "packaging_type": "Plastic" },
      { "name": "Coffee", "brand": "", "category": "Beverages", "packaging_type": "Paper" },
      { "name": "Organic Ginger", "brand": "", "category": "Produce", "packaging_type": "Plastic" },
      { "name": "Green Tea Matcha Blend", "brand": "", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Milk", "brand": "", "category": "Dairy", "packaging_type": "Carton" },
      { "name": "Ice Cream", "brand": "", "category": "Frozen Desserts", "packaging_type": "Carton" },
      { "name": "Formula", "brand": "", "category": "Baby Food", "packaging_type": "Metal" },
      { "name": "Raisin Bran Cereal", "brand": "", "category": "Breakfast Cereal", "packaging_type": "Carton" },
      { "name": "Nespresso Coffee Machine", "brand": "Nespresso", "category": "Home Appliances", "packaging_type": "Plastic" },
      { "name": "Chipotle Chicken Bowl", "brand": "Chipotle", "category": "Fast Food", "packaging_type": "Plastic" },
      { "name": "Philz Coffee", "brand": "Philz", "category": "Beverages", "packaging_type": "Paper" },
      { "name": "Carlsbad Alkaline Water", "brand": "Carlsbad", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Coca-Cola Diet Coke", "brand": "Coca-Cola", "category": "Beverages", "packaging_type": "Metal" },
      { "name": "Mountain Valley Spring Water", "brand": "Mountain Valley", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Ziploc Storage Bag", "brand": "Ziploc", "category": "Food Storage", "packaging_type": "Plastic" },
      { "name": "Kraft Singles American Cheese Slices", "brand": "Kraft Singles", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Kirkland Coarse Ground Black Pepper", "brand": "Kirkland", "category": "Spices", "packaging_type": "Plastic" },
      { "name": "Kirkland Wild Caught Alaska Halibut", "brand": "Kirkland", "category": "Frozen Seafood", "packaging_type": "Plastic" },
      { "name": "Sargento Sliced Sharp Natural Cheddar Cheese", "brand": "Sargento", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Kirkland Wild Caught Mahi-Mahi", "brand": "Kirkland", "category": "Frozen Seafood", "packaging_type": "Plastic" },
      { "name": "Splenda", "brand": "", "category": "Sweeteners", "packaging_type": "Paper" },
      { "name": "Mixed Nuts", "brand": "", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "Starbucks Coffee K-Cups", "brand": "Starbucks", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Bulk Supplements Whey Protein Isolate Powder", "brand": "Bulk Supplements", "category": "Sports Nutrition", "packaging_type": "Plastic" },
      { "name": "Acqua Panna Water", "brand": "Acqua Panna", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Yakult", "brand": "", "category": "Probiotics", "packaging_type": "Plastic" },
      { "name": "Kerrygold Butter", "brand": "Kerrygold", "category": "Dairy", "packaging_type": "Paper" },
      { "name": "ZeroWater Water Filter", "brand": "ZeroWater", "category": "Home Appliances", "packaging_type": "Plastic" },
      { "name": "Organic India Tea Bags", "brand": "Organic India", "category": "Beverages", "packaging_type": "Paper" },
      { "name": "Kirkland Protein Bar", "brand": "Kirkland", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "Aussie Lemonade", "brand": "Aussie", "category": "Beverages", "packaging_type": "Metal" },
      { "name": "Lucozade Alert Cherry Blast Energy Drink", "brand": "Lucozade Alert", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Kirkland Water Bottles", "brand": "Kirkland", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Vitamin Gummy", "brand": "", "category": "Supplements", "packaging_type": "Plastic" },
      { "name": "Anti-Depression Medicines", "brand": "", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Analgesic Bottles", "brand": "", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Analgesic Tablets", "brand": "", "category": "Medication", "packaging_type": "Plastic" },
      { "name": "Naked Nutrition Whey Protein Powder", "brand": "Naked Nutrition", "category": "Sports Nutrition", "packaging_type": "Plastic" },
      { "name": "Topo Chico Mineral Water", "brand": "Topo Chico", "category": "Beverages", "packaging_type": "Glass" },
      { "name": "Kirkland Signature Organic Multivitamin", "brand": "Kirkland Signature", "category": "Supplements", "packaging_type": "Plastic" },
      { "name": "Simple Mills Cheddar Pop Mmms Baked Snack Crackers", "brand": "Simple Mills", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "Mila Soup Dumplings", "brand": "Mila", "category": "Frozen Foods", "packaging_type": "Plastic" },
      { "name": "Safe Catch Garlic Herb Elite Tuna", "brand": "Safe Catch", "category": "Canned Seafood", "packaging_type": "Metal" },
      { "name": "Kirkland Signature Organic Tuscan Marinara", "brand": "Kirkland Signature", "category": "Pasta Sauce", "packaging_type": "Glass" },
      { "name": "3M CLINPRO Toothpaste", "brand": "3M CLINPRO", "category": "Oral Care", "packaging_type": "Plastic" },
      { "name": "Siggi's Yogurt", "brand": "Siggi's", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Spring Water", "brand": "", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "365 by Whole Foods Market Iced Tea", "brand": "365 by Whole Foods Market", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Ascent Whey Protein Powder", "brand": "Ascent", "category": "Sports Nutrition", "packaging_type": "Plastic" },
      { "name": "Nature's Bakery Fig Bars", "brand": "Nature's Bakery", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "Athletic Greens AG1", "brand": "Athletic Greens", "category": "Supplements", "packaging_type": "Plastic" },
      { "name": "Kettle Brand Potato Chips", "brand": "Kettle Brand", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "Psyllium Husk", "brand": "", "category": "Supplements", "packaging_type": "Plastic" },
      { "name": "Bob's Red Mill Quick Cooking Steel Cut Oats", "brand": "Bob's Red Mill", "category": "Breakfast Cereal", "packaging_type": "Plastic" },
      { "name": "Gatorade", "brand": "", "category": "Sports Drinks", "packaging_type": "Plastic" },
      { "name": "Sardines", "brand": "", "category": "Canned Seafood", "packaging_type": "Metal" },
      { "name": "Bamba", "brand": "", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "1MD Women's Probiotics", "brand": "1MD", "category": "Supplements", "packaging_type": "Plastic" },
      { "name": "Olive Oil", "brand": "", "category": "Cooking Ingredients", "packaging_type": "Glass" },
      { "name": "Loose Leaf Tea", "brand": "", "category": "Beverages", "packaging_type": "Paper" },
      { "name": "Chestnuts", "brand": "", "category": "Nuts", "packaging_type": "Plastic" },
      { "name": "Salmon Roe", "brand": "", "category": "Seafood", "packaging_type": "Plastic" },
      { "name": "Lipton Tea Bag", "brand": "Lipton", "category": "Beverages", "packaging_type": "Paper" },
      { "name": "Fiji Water", "brand": "Fiji", "category": "Beverages", "packaging_type": "Plastic" },
      { "name": "Goldfish Crackers", "brand": "", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "Tabasco", "brand": "", "category": "Condiments", "packaging_type": "Glass" },
      { "name": "Graza Olive Oil", "brand": "Graza", "category": "Cooking Ingredients", "packaging_type": "Metal" },
      { "name": "King Arthur Flour", "brand": "King Arthur", "category": "Baking Ingredients", "packaging_type": "Paper" },
      { "name": "Mary's Free Range Chicken", "brand": "Mary's", "category": "Meat", "packaging_type": "Plastic" },
      { "name": "Nancy's Whole Milk Yogurt", "brand": "Nancy's", "category": "Dairy", "packaging_type": "Plastic" },
      { "name": "Bored Jerky", "brand": "Bored", "category": "Snacks", "packaging_type": "Plastic" },
      { "name": "Cheez-It Crackers", "brand": "", "category": "Snacks", "packaging_type": "Plastic" },
      ...
      { "name": "Coffee Maker", "brand": "", "category": "Home Appliances", "packaging_type": "Plastic" },
      { "name": "Fairlife Nutrition Plan Protein Shake", "brand": "Fairlife Nutrition Plan", "category": "Sports Nutrition", "packaging_type": "Plastic" },
