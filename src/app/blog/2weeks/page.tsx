    ...
    <main className="min-h-screen max-w-4xl flex flex-col mx-auto p-8 justify-between gap-8">
      <div className="flex flex-col gap-8">
        ...
        <div className="flex flex-col gap-4">
          ...
          <p className="text-gray-500">Published: 2024-06-10</p>
          ...
          <div className="flex flex-col items-center">
            <Image src="/blog/desks.png" alt="PlasticList team assembling our desks in late May" width={500} height={250} />
          ...
          <ol className="list-decimal pl-5 space-y-2">
            <li>We plan to test foods that the tech community eats in the Bay Area for various plastic-related endocrine-disrupting chemicals.</li>
            <li>We plan to publish everything we learn along the way, so that others can evaluate, replicate, and build on our work.</li>
          </ol>
          ...
          <p className="font-bold">Selecting foods to test</p>
          ...
          <ol className="list-decimal pl-5">
            ...
            <li><b>Broccoli:</b> 6 products</li>
            <li><b>Strawberries:</b> 6 products</li>
            <li><b>Yogurt:</b> 6 products</li>
            <li><b>Milk:</b> 7 products</li>
            <li><b>Chicken:</b> 8 products</li>
            <li><b>Soda:</b> 13 products</li>
            <li><b>Coffee:</b> 11 products</li>
            <li><b>Chocolate:</b> 3 products</li>
            <li><b>Tablets:</b> 5 products</li>
          </ol>
          <p>We are still finalizing our exact list of foods to test. In practice, the available matrices may be limited by our budget and the capabilities of the available labs. Within the list, there are a few questions we hope to explore, such as whether and to what extent different types of food containers might leach plastic chemicals into our foods. We are amateurs and our study will be relatively small, so we don’t expect our data to definitively answer any questions. It should be interesting, though! We’ll share more information on the specific tests we are running when we have it.</p>
          ...
          <p>From there, we worked with an analytical chemist to choose the most relevant chemicals that we could realistically test this year. We narrowed it down to this list:</p>
          <ol className="list-decimal pl-5">
